...
class Pengguna extends CI_Controller
{
    ...
    public function lihat($id)
    {
        ...
        $data['result_kuisioner'] = $this->db->query("SELECT kuisioner.1+kuisioner.2+kuisioner.3+kuisioner.4+kuisioner.5+kuisioner.6+kuisioner.7+kuisioner.8+kuisioner.9+kuisioner.10+kuisioner.11+kuisioner.12+kuisioner.13+kuisioner.14 as result FROM kuisioner WHERE id_user = $id ORDER BY id_kuisioner DESC LIMIT 1")->row_array();
